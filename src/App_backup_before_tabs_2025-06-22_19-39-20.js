              ...
              <div style={{ 
                ...
                <button
                  style={{
                    ...
                    borderRadius: '0', // 네모 모양
                    cursor: 'pointer',
                    backgroundColor: selectedNotebookId === 'all' ? '#007bff' : 'transparent', // 파란색으로 변경
                    color: selectedNotebookId === 'all' ? 'white' : styles.text,
                    transition: 'all 0.2s',
                    whiteSpace: 'nowrap'
                  }}
                ...
                {appData.notebooks.map(notebook => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '0', // 네모 모양
                      cursor: 'pointer',
                      backgroundColor: selectedNotebookId === notebook.id ? '#007bff' : 'transparent', // 파란색으로 변경
                      color: selectedNotebookId === notebook.id ? 'white' : styles.text,
                      transition: 'all 0.2s',
                      whiteSpace: 'nowrap'
                    }}
                ...
                <button
                  style={{
                    ...
                    fontSize: '14px',
                    fontWeight: '600',
                    border: '1px dashed ' + styles.success,
                    borderRadius: '0',
                    cursor: 'pointer',
